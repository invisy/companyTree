    ...
    public class ByPositionStrategyTest
    {
        ...
        public void RightOrderTest()
        {
            ...
            List<Employee> expectedResult = new List<Employee>( 
                new[] { director.Object, supplyManager.Object, salesManager.Object, employeeX.Object, 
                    employeeY.Object, employeeA.Object, employeeB.Object }
            );
            
            CompanyStructureByPositionStrategy strategy = new CompanyStructureByPositionStrategy();
