...
namespace CompanyTree.Tests
{
    ...
    {
        private static Mock<EmployeeX> employeeX;
        private static Mock<EmployeeY> employeeY;
        private static Mock<EmployeeX> employeeX2;
        private static Mock<EmployeeY> employeeY2;
        private static Mock<EmployeeA> employeeA;
        private static Mock<EmployeeB> employeeB;
        private static Mock<SupplyManager> supplyManager;
        private static Mock<SalesManager> salesManager;
        private static Mock<Director> director;
